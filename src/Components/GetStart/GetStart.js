            ...
            <div className="bg-[#00131B] px-[40px] md:px-[136px] py-[35px] md:py-[50px] ">
                ...
                <div className='flex justify-start xl:justify-between items-start xl:items-center xl:flex-row flex-col gap-[30px] md:gap-[70px] '>
                    <div>
                        ...
                        <p className='text-[#33DDB3] text-[13px] leading-[16px] '>Stably for businesses</p>
                    </div>
                    <div>
                ...
                {/* middle */}
                <div className='grid  grid-cols-3 xl:grid-cols-12 pt-[70px] gap-[50px]  border-t border-white mt-[70px]'>
                    <div className=' col-span-3'>
                        <div>
                            <img src={publicLink('/footer-logo.png')} alt="logo" />
                        </div>
                        <p className='mt-[15px] w-[244px] md:mt-[30px]'>
                ...
                <div className='mt-[50px] md:mt-[70px] xl:flex items-center justify-between py-[30px] border-t border-white/[.3] mb-[40px]'>
                    <div>
