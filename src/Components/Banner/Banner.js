    ...
    return (
        <div className='banner-wrap py-res-xl md:pt-[176px] '>
            <div className='container '>
                <div className="flex flex-col lg:flex-row   justify-between  gap-[30px] xl:gap-[92px]">
                    <div className=' xl:min-w-[588px] xl:w-[588px]  lg:w-[440px] flex justify-center md:justify-start items-center'>
                        <div>
                            ...
                            <p className='my-[30px]  md:w-[462px] text-res-normal leading-[26px]'>The top <span className='font-bold'>fiat {'<>'} crypto</span> gateway for stablecoins and alternative digital assets</p>
