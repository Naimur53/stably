...
const Banner = () => {
    ...
    return (
        <div className='banner-wrap py-res-xl xl:pt-[176px] '>
                    ...
                    <div className=' xl:min-w-[588px] xl:w-[588px] md:col-span-7 flex justify-center md:justify-start items-center'>
                        <div>
                            ...
                            <div className='flex gap-[20px]'>
                                <button className='bg-inner-black nav-button text-[#E3FFF2] rounded-[8px] font-bold text-res-xxs leading-[18px]'>Buy & Sell</button>
                                <button className='nav-button font-bold border border-inner-black text-inner-black inline-block   leading-[17px] '>Sign up</button>
